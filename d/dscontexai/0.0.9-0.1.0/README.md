# Comparing `tmp/dscontexai-0.0.9.tar.gz` & `tmp/dscontexai-0.1.0.tar.gz`
...
## Comparing `dscontexai-0.0.9.tar` & `dscontexai-0.1.0.tar`
...
### Comparing `dscontexai-0.0.9/dscontexai/dsc_grammar.py` & `dscontexai-0.1.0/dscontexai/dsc_grammar.py`
...
### Comparing `dscontexai-0.0.9/dscontexai/dsc_ploting.py` & `dscontexai-0.1.0/dscontexai/dsc_ploting.py`
...
### Comparing `dscontexai-0.0.9/dscontexai/dsc_xgboost.py` & `dscontexai-0.1.0/dscontexai/dsc_xgboost.py`
...
### Comparing `dscontexai-0.0.9/dscontexai/grammar_with_box_latex.py` & `dscontexai-0.1.0/dscontexai/grammar_with_box_latex.py`
...
### Comparing `dscontexai-0.0.9/dscontexai.egg-info/requires.txt` & `dscontexai-0.1.0/dscontexai.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `dscontexai-0.0.9/setup.py` & `dscontexai-0.1.0/setup.py`
...
-    package_data={"latex_styles": ["./latex/neurips_2023"]},
     install_requires=[
         "asttokens==2.4.1",
         "backcall==0.2.0",
         "catboost==1.2.5",
