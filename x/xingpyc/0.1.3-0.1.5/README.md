# Comparing `tmp/xingpyc-0.1.3.tar.gz` & `tmp/xingpyc-0.1.5.tar.gz`
...
## Comparing `xingpyc-0.1.3.tar` & `xingpyc-0.1.5.tar`
...
### Comparing `xingpyc-0.1.3/PKG-INFO` & `xingpyc-0.1.5/PKG-INFO`
...
### Comparing `xingpyc-0.1.3/pyproject.toml` & `xingpyc-0.1.5/pyproject.toml`
...
### Comparing `xingpyc-0.1.3/src/xingpyc/__init__.py` & `xingpyc-0.1.5/src/xingpyc/__init__.py`
...
### Comparing `xingpyc-0.1.3/src/xingpyc.egg-info/PKG-INFO` & `xingpyc-0.1.5/src/xingpyc.egg-info/PKG-INFO`
