# Comparing `tmp/zenaura-0.9.33.tar.gz` & `tmp/zenaura-0.9.74.tar.gz`
...
## Comparing `zenaura-0.9.33.tar` & `zenaura-0.9.74.tar`
...
### Comparing `zenaura-0.9.33/LICENSE` & `zenaura-0.9.74/LICENSE`

 * *Files identical despite different names*

### Comparing `zenaura-0.9.33/PKG-INFO` & `zenaura-0.9.74/PKG-INFO`
...
### Comparing `zenaura-0.9.33/tests/test_compiler.py` & `zenaura-0.9.74/tests/test_compiler.py`
...
### Comparing `zenaura-0.9.33/tests/test_component_e2e.py` & `zenaura-0.9.74/tests/test_component_e2e.py`
...
### Comparing `zenaura-0.9.33/tests/test_component_unit.py` & `zenaura-0.9.74/tests/test_component_unit.py`
...
### Comparing `zenaura-0.9.33/tests/test_observer.py` & `zenaura-0.9.74/tests/test_observer.py`

 * *Files identical despite different names*

### Comparing `zenaura-0.9.33/tests/test_tags.py` & `zenaura-0.9.74/tests/test_tags.py`
...
### Comparing `zenaura-0.9.33/zenaura.egg-info/PKG-INFO` & `zenaura-0.9.74/zenaura.egg-info/PKG-INFO`
