# Comparing `tmp/compressed_tensors_nightly-0.3.3.20240524-py3-none-any.whl.zip` & `tmp/compressed_tensors_nightly-0.3.3.20240525-py3-none-any.whl.zip`
...
+Zip file size: 64190 bytes, number of entries: 43
+-rw-r--r--  2.0 unx      789 b- defN 24-May-25 00:03 compressed_tensors/__init__.py
+-rw-r--r--  2.0 unx      755 b- defN 24-May-25 00:03 compressed_tensors/base.py
+-rw-r--r--  2.0 unx     1512 b- defN 24-May-25 00:03 compressed_tensors/version.py
+-rw-r--r--  2.0 unx      992 b- defN 24-May-25 00:03 compressed_tensors/compressors/__init__.py
+-rw-r--r--  2.0 unx     2134 b- defN 24-May-25 00:03 compressed_tensors/compressors/base.py
+-rw-r--r--  2.0 unx     1257 b- defN 24-May-25 00:03 compressed_tensors/compressors/dense.py
+-rw-r--r--  2.0 unx     5403 b- defN 24-May-25 00:03 compressed_tensors/compressors/helpers.py
+-rw-r--r--  2.0 unx     5203 b- defN 24-May-25 00:03 compressed_tensors/compressors/int_quantized.py
+-rw-r--r--  2.0 unx    10481 b- defN 24-May-25 00:03 compressed_tensors/compressors/model_compressor.py
+-rw-r--r--  2.0 unx     8344 b- defN 24-May-25 00:03 compressed_tensors/compressors/pack_quantized.py
+-rw-r--r--  2.0 unx     8637 b- defN 24-May-25 00:03 compressed_tensors/compressors/sparse_bitmask.py
+-rw-r--r--  2.0 unx      704 b- defN 24-May-25 00:03 compressed_tensors/config/__init__.py
+-rw-r--r--  2.0 unx     1454 b- defN 24-May-25 00:03 compressed_tensors/config/base.py
+-rw-r--r--  2.0 unx     1317 b- defN 24-May-25 00:03 compressed_tensors/config/dense.py
+-rw-r--r--  2.0 unx     1308 b- defN 24-May-25 00:03 compressed_tensors/config/sparse_bitmask.py
+-rw-r--r--  2.0 unx      760 b- defN 24-May-25 00:03 compressed_tensors/quantization/__init__.py
+-rw-r--r--  2.0 unx     4360 b- defN 24-May-25 00:03 compressed_tensors/quantization/quant_args.py
+-rw-r--r--  2.0 unx     8727 b- defN 24-May-25 00:03 compressed_tensors/quantization/quant_config.py
+-rw-r--r--  2.0 unx     3571 b- defN 24-May-25 00:03 compressed_tensors/quantization/quant_scheme.py
+-rw-r--r--  2.0 unx      798 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/__init__.py
+-rw-r--r--  2.0 unx     7984 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/apply.py
+-rw-r--r--  2.0 unx     1776 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/calibration.py
+-rw-r--r--  2.0 unx     2247 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/compressed.py
+-rw-r--r--  2.0 unx    10520 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/forward.py
+-rw-r--r--  2.0 unx     1726 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/frozen.py
+-rw-r--r--  2.0 unx     3732 b- defN 24-May-25 00:03 compressed_tensors/quantization/lifecycle/initialize.py
+-rw-r--r--  2.0 unx      745 b- defN 24-May-25 00:03 compressed_tensors/quantization/observers/__init__.py
+-rw-r--r--  2.0 unx     5121 b- defN 24-May-25 00:03 compressed_tensors/quantization/observers/base.py
+-rw-r--r--  2.0 unx     2166 b- defN 24-May-25 00:03 compressed_tensors/quantization/observers/helpers.py
+-rw-r--r--  2.0 unx     2165 b- defN 24-May-25 00:03 compressed_tensors/quantization/observers/memoryless.py
+-rw-r--r--  2.0 unx     3669 b- defN 24-May-25 00:03 compressed_tensors/quantization/observers/min_max.py
+-rw-r--r--  2.0 unx      656 b- defN 24-May-25 00:03 compressed_tensors/quantization/utils/__init__.py
+-rw-r--r--  2.0 unx     6017 b- defN 24-May-25 00:03 compressed_tensors/quantization/utils/helpers.py
+-rw-r--r--  2.0 unx      658 b- defN 24-May-25 00:03 compressed_tensors/registry/__init__.py
+-rw-r--r--  2.0 unx    11890 b- defN 24-May-25 00:03 compressed_tensors/registry/registry.py
+-rw-r--r--  2.0 unx      665 b- defN 24-May-25 00:03 compressed_tensors/utils/__init__.py
+-rw-r--r--  2.0 unx     1735 b- defN 24-May-25 00:03 compressed_tensors/utils/helpers.py
+-rw-r--r--  2.0 unx     8502 b- defN 24-May-25 00:03 compressed_tensors/utils/safetensors_load.py
+-rw-r--r--  2.0 unx    11357 b- defN 24-May-25 00:05 compressed_tensors_nightly-0.3.3.20240525.dist-info/LICENSE
+-rw-r--r--  2.0 unx     5633 b- defN 24-May-25 00:05 compressed_tensors_nightly-0.3.3.20240525.dist-info/METADATA
+-rw-r--r--  2.0 unx       92 b- defN 24-May-25 00:05 compressed_tensors_nightly-0.3.3.20240525.dist-info/WHEEL
+-rw-r--r--  2.0 unx       19 b- defN 24-May-25 00:05 compressed_tensors_nightly-0.3.3.20240525.dist-info/top_level.txt
+-rw-rw-r--  2.0 unx     4376 b- defN 24-May-25 00:05 compressed_tensors_nightly-0.3.3.20240525.dist-info/RECORD
+43 files, 161957 bytes uncompressed, 56922 bytes compressed:  64.9%
```
...
+Filename: compressed_tensors_nightly-0.3.3.20240525.dist-info/LICENSE
 Comment: 
 
-Filename: compressed_tensors_nightly-0.3.3.20240524.dist-info/METADATA
+Filename: compressed_tensors_nightly-0.3.3.20240525.dist-info/METADATA
 Comment: 
 
-Filename: compressed_tensors_nightly-0.3.3.20240524.dist-info/WHEEL
+Filename: compressed_tensors_nightly-0.3.3.20240525.dist-info/WHEEL
 Comment: 
 
-Filename: compressed_tensors_nightly-0.3.3.20240524.dist-info/top_level.txt
+Filename: compressed_tensors_nightly-0.3.3.20240525.dist-info/top_level.txt
 Comment: 
 
-Filename: compressed_tensors_nightly-0.3.3.20240524.dist-info/RECORD
+Filename: compressed_tensors_nightly-0.3.3.20240525.dist-info/RECORD
 Comment: 
 
 Zip file comment:
```

## Comparing `compressed_tensors_nightly-0.3.3.20240524.dist-info/LICENSE` & `compressed_tensors_nightly-0.3.3.20240525.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `compressed_tensors_nightly-0.3.3.20240524.dist-info/METADATA` & `compressed_tensors_nightly-0.3.3.20240525.dist-info/METADATA`
...
## Comparing `compressed_tensors_nightly-0.3.3.20240524.dist-info/RECORD` & `compressed_tensors_nightly-0.3.3.20240525.dist-info/RECORD`
